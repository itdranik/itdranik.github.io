...
Как упоминалось в предыдущих постах про [постфиксную нотацию](/ru/math-expressions-postfix-notation-ru/) и [алгоритм сортировочной станции](/ru/math-expressions-shunting-yard-algorithm-ru/), мы имеем следующие виды токенов:
...
Как всегда полную реализацию можно посмотреть на [GitHub](https://github.com/itdranik/coding-interview-en/) проекта coding-interview-en, а этим постом будем заканчивать тему разбора математических выражений. Надеюсь, что всё было познавательно и интересно. До встречи!
