...
С полной реализацией алгоритма на C# можно ознакомиться на GitHub проекта [coding-interview-en](https://github.com/itdranik/coding-interview-en). Ниже остановимся на самых интересных моментах. Пусть текущее состояние описывается следующим набором параметров и методов:
