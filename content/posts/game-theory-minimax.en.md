...
The full implementation of the algorithm in C# can be found on the GitHub of the [coding-interview-en](https://github.com/itdranik/coding-interview-en) project. Below we will focus on the most interesting points. Let the current state be described by the following set of parameters and methods:
