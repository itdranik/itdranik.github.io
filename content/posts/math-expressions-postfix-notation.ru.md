...
На этом мне надо прощаться, а уже в [следующем посте](/ru/math-expressions-shunting-yard-algorithm-ru/) разберём реализацию алгоритма сортировочной станции.
