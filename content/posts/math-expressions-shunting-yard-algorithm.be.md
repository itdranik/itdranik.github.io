...
url: /be/math-expressions-shunting-yard-algorithm-be/
...
Поўную рэалізацыю можна паглядзець на [GitHub](https://github.com/itdranik/coding-interview-en/) праекта coding-interview-en. На гэтым будзем заканчваць разбор алгарытму сартавальнай станцыі, і, не губляючы часу, пераходзім да алгарытму такенізацыі, які апісаны ў [наступным пасце](/be/math-expressions-tokenization-be/).
