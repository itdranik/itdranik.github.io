...
З поўнай рэалізацыяй алгарытму на C# можна азнаёміцца на GitHub праекта [coding-interview-en](https://github.com/itdranik/coding-interview). Ніжэй спынімся на самых цікавых момантах. Хай бягучы стан апісваецца наступным наборам параметраў і метадаў:
