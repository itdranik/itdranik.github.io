...
Але гэта стандартнае пытанне. А мы вернемся да нестандартнага. У [папярэднім пасце](/be/caching-lru-algorithm/) мы ўжо пазнаёміліся з кэшаваннем і алгарытмам LRU выцяснення элементаў. Прапаную разгледзець наступны прыклад:
