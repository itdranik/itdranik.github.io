...
Але гэта стандартнае пытанне. А мы вернемся да нестандартнага. У [папярэднім пасце](/be/post/caching-lru-algorithm/) мы ўжо пазнаёміліся з кэшаваннем і алгарытмам LRU выцяснення элементаў. Прапаную разгледзець наступны прыклад:
...
На гэтым рэалізацыя LFU кэшавання скончана. Мне трэба развітвацца, а табе, дарагі чытач, прапаную азнаёміцца з [іншымі разборамі задач](/be/categories/coding-interview/), якія могуць трапляцца на тэхнічных сумоўях. Да хуткіх сустрэч!
