...
Как упоминалось в предыдущих постах про [постфиксную нотацию](/ru/math-expressions-postfix-notation/) и [алгоритм сортировочной станции](/ru/math-expressions-shunting-yard-algorithm/), мы имеем следующие виды токенов:
