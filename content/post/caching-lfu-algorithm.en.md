...
But this is a standard question. And we will return to a non-standard one. In the [previous post](/post/caching-lru-algorithm/), we have already got acquainted with caching and the LRU algorithm of element eviction. I propose to consider the following example:
...
This completes the implementation of LFU caching. I need to say goodbye. And I'd like to ask you, dear reader, to familiarize yourself also with the other reviews of [coding-interview problems](/categories/coding-interview/). See you soon!
