...
At this, I need to say goodbye while in the [next post](/post/math-expressions-shunting-yard-algorithm/) we will analyze the implementation of the shunting-yard algorithm.
