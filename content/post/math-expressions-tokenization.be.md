...
Як згадвалася ў папярэдніх пастах пра [постфіксную натацыю](/be/math-expressions-postfix-notation/) і [алгарытм сартавальнай станцыі](/be/math-expressions-shunting-yard-algorithm/), мы маем наступныя віды токенаў:
