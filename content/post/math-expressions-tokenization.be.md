...
Як згадвалася ў папярэдніх пастах пра [постфіксную натацыю](/be/post/math-expressions-postfix-notation/) і [алгарытм сартавальнай станцыі](/be/post/math-expressions-shunting-yard-algorithm/), мы маем наступныя віды токенаў:
