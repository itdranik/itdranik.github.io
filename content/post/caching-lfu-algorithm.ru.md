...
Но это стандартный вопрос. А мы вернёмся к нестандартному. В [предыдущем посте](/ru/post/caching-lru-algorithm/) мы уже познакомились с кэшированием и алгоритмом LRU вытеснения элементов. Предлагаю рассмотреть следующий пример:
